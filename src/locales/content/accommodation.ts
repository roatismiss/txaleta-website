...
const en: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "Free Parking", note: "On-site parking for guests, right at the door." },
    { label: "Airport Transfers", note: "Arranged on request — fifteen minutes from Camiguin Airport." },
...
const fr: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "Parking gratuit", note: "Stationnement sur place pour nos hôtes, juste devant la porte." },
    { label: "Transferts aéroport", note: "Organisés sur demande — à quinze minutes de l'aéroport de Camiguin." },
...
const de: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "Kostenlose Parkplätze", note: "Stellplätze für Gäste direkt vor der Tür." },
    { label: "Flughafentransfer", note: "Auf Anfrage organisiert — fünfzehn Minuten vom Flughafen Camiguin." },
...
const ja: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "無料駐車場", note: "ご滞在中の駐車場を玄関前にご用意。" },
    { label: "空港送迎", note: "ご要望に応じて手配 — カミギン空港から15分。" },
...
const ko: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "무료 주차", note: "문 앞 투숙객 전용 주차 공간." },
    { label: "공항 픽업", note: "요청 시 준비해 드립니다 — 카미긴 공항에서 15분." },
...
const zh: AccommodationDict = {
  ...
  inclusions: [
    ...
    { label: "免费停车", note: "门口即有住客专用停车位。" },
    { label: "机场接送", note: "可应要求安排——距卡米金机场十五分钟。" },
