...
export async function Accommodation({ lang = "en" }: { lang?: Locale }) {
  const t = homeSections[lang].accommodation;
    ...
    <section id="accommodation" className="relative overflow-hidden bg-cream py-24 sm:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-ink/65">{t.intro}</p>
        </Reveal>
