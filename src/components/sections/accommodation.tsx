      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-[15px] leading-relaxed text-ink/65">
            ...
            no two open onto the same view — with ten more coming soon. Some face the Bohol Sea,
            others the garden or the cliff&apos;s edge. Choose the one that matches how you want to
            meet the morning.
          </p>
        </Reveal>
